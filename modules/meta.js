...
module.exports = {
  help: async function (message, args) {
    ...
    var meta = ['help', 'ping', 'posix', 'uptime']
    var utils = ['qr', 'roll', 'metar', 'taf', 'dice']
    var network = ['ip']
    var fun = ['op', 'bless', 'askgod', 'verse', 'kill', 'infect', 'yn', 'dox', 'give', 'kit', 'uuid', 'tp', 'helloworld', 'randomtp', 'randomtpall', 'yeet', 'randompaintp']
    var music = ['play', 'playlist', 'skip', 'stop', 'loop', 'volume', 'seek', 'queue', 'shuffle', 'pause', 'resume', 'remove', 'leave']
